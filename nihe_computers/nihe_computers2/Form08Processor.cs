...
namespace nihe_computers2
{
    public partial class Form08Processor : Form
    {
        ...
        public Form08Processor(Class1 C1, BindingSource BSProcessor)
        {
            this.BSProcessor = BSProcessor;
            this.BSProcessor.Sort = "FullName";
            InitializeComponent();
            processorDataGridView.DataSource = BSProcessor;
            processorBindingNavigator.BindingSource = BSProcessor;

            socketIDDataGridViewTextBoxColumn.DataSource = C1.DS.Socket.Select("", "sort");
            vendorIDDataGridViewTextBoxColumn.DataSource = C1.DS.Vendor;
        }
